<div class="body">
	...
	<form method="post" action="">
		<div class="input-group">
			...
			<input class="half" type="text" name="full_name" placeholder="Ձեր լրիվ անունը" required="true">
		</div>

		<div class="input-group">
			<span class="input-label"><?php echo $lang['email'] ?></span>
			<input class="half" type="email" name="email" placeholder="Ձեր էլփոստը" required="true">
		</div>

		<div class="input-group">
			<span class="input-label"><?php echo $lang['username'] ?></span>
			<input class="half" type="text" name="username" placeholder="Ձեր օգտանունը" required="true">
		</div>

		<div class="input-group">
			<span class="input-label"><?php echo $lang['password'] ?></span>
			<input class="half" type="password" name="password" placeholder="Ձեր ապահով գաղտնաբառը" required="true">
		</div>
